    ...
    <el-dialog title="提示" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
      ...
      >
        ...
        <el-form-item label="商品价格" prop="price">
          <el-input-number v-model="ruleForm.price" controls-position="right" :min="1" :max="10" class="inputs"></el-input-number>
        </el-form-item>
        <el-form-item label="商品数量" prop="num">
          <el-input-number v-model="ruleForm.num" controls-position="right" :min="1" :max="10" class="inputs"></el-input-number>
        </el-form-item>
        <el-form-item label="商品重量" prop="weight">
          <el-input-number v-model="ruleForm.weight" controls-position="right" :min="1" :max="10" class="inputs"></el-input-number>
        </el-form-item>
      </el-form>
