...
<el-tree
  ...
  <span slot="footer" class="dialog-footer">
    ...
    <el-button type="primary" @click="getCheckedKeys(scope.row)">确 定</el-button>
  </span>
</el-dialog>
    <!--内容开始-->
    <div class="button">
...
export default {
  ...
  components: {},
  methods: {
    ...mapActions(["getRoles", "postAddrole", "deleteRole", "editRole","getRights","setRoles"]),
    handleCheckChange(){
