  ...
  inactive-color="#ff4949" @change="change(scope.row)">
     ...
     <el-table-column
      ...
      <div class="d-f" slot-scope="scope">
        <el-button type="primary" icon="el-icon-edit" size="mini" @click="dialogVisibles = true"></el-button>
        <el-dialog
  title="提示"
   ...
   <el-form
          ...
          >
            ...
            <el-form-item label="邮箱" prop="emails">
              <el-input v-model="ruleForms.email"  placeholder="请输入邮箱"></el-input>
            </el-form-item>
            <el-form-item label="电话" prop="phones">
              <el-input v-model="ruleForms.phone"  placeholder="请输入电话"></el-input>
            </el-form-item>
          </el-form>
  <span slot="footer" class="dialog-footer">
 ...
 export default {
   ...
   methods: {
    ...
    //添加用户
     ...
     ...mapActions(['getUserList','getState','getParty','getDelete']),
