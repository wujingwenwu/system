...
export default {
  ...
  getList({ pagenum, pagesize }) {
    return service.get(`categories?pagenum=${pagenum}&pagesize=${pagesize}`)
  },
  postGoods({ goods_name, goods_cat,goods_price,goods_number,goods_weight }) {
    return service.post(`categories?pagenum=${pagenum}&pagesize=${pagesize}`)
  },
}