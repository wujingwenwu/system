        ...
        <div>
          ...
          >
            ...
            <el-form-item label="商品重量" prop="weights">
              <el-input-number :disabled="ruleForm.plices==number('0') ?true:false" v-model="ruleForm.weights" controls-position="right" class="input"></el-input-number>
            </el-form-item>
            <el-form-item label="商品数量" prop="number">
              <el-input-number :disabled="ruleForm.weights===''?true:false" v-model="ruleForm.number" controls-position="right" class="input"></el-input-number>
            </el-form-item>
            <el-form-item label="商品分类" prop="classification">
              <el-cascader :disabled="ruleForm.number===''?true:false" v-model="ruleForm.classification" :options="goodser"></el-cascader>
            </el-form-item>
          </el-form>
        </div>
      </div>
