        ...
        <div>
          ...
          >
            ...
            <el-form-item label="商品分类" prop="classification">
              <el-cascader :disabled="ruleForm.number===0?true:false" v-model="value" :props="props" :options="list"></el-cascader>
            </el-form-item>
          </el-form>
          <el-button type="success" v-if="value !==''" @click="">下一步</el-button>
        </div>
      </div>
    </div>
  </div>
