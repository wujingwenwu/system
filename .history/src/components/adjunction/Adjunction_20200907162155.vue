        ...
        <div>
          ...
          >
            ...
            <el-form-item label="商品价格" prop="plices">
              <el-input-number :disabled="ruleForm.name===null?true:false"  v-model="ruleForm.plices" controls-position="right" class="input"></el-input-number>
            </el-form-item>
            <el-form-item label="商品重量" prop="weights">
              <el-input-number v-model="ruleForm.weights" controls-position="right" class="input"></el-input-number>
            </el-form-item>
            <el-form-item label="商品数量" prop="number">
              <el-input-number v-model="ruleForm.number" controls-position="right" class="input"></el-input-number>
            </el-form-item>
            <el-form-item label="商品分类" prop="classification">
              <el-cascader v-model="ruleForm.name" :options="goodser"></el-cascader>
            </el-form-item>
          </el-form>
        </div>
      </div>
