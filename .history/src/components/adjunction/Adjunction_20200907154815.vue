        ...
        <div>
          ...
          >
            ...
            <el-form-item label="商品价格" prop="plices">
              <el-input-number v-model="ruleForm.plices" controls-position="right" class="input"></el-input-number>
            </el-form-item>
            ...
            <el-form-item label="商品分类" prop="classification">
              <el-cascader v-model="ruleForm.name" :options="options" @change="handleChange"></el-cascader>
              <el-input v-model="ruleForm.name" class="input"></el-input>
            </el-form-item>
          </el-form>
        </div>
